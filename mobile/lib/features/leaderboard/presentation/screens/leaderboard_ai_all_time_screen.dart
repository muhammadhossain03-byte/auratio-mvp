...
class LeaderboardAiAllTimeScreen extends ConsumerWidget {
  const LeaderboardAiAllTimeScreen({super.key});

  static const screenKey = Key('leaderboard-ai-all-time-screen');
  static const trackTitleKey = Key('leaderboard-ai-track-title');
  static const pathLabelKey = Key('leaderboard-ai-path-label');
  static const modePillsRowKey = Key('leaderboard-ai-mode-pills-row');
  static const modeAiPillKey = Key('leaderboard-ai-mode-ai-pill');
  static const modeHumanPillKey = Key('leaderboard-ai-mode-human-pill');
  static const periodPillsRowKey = Key('leaderboard-ai-period-pills-row');
  static const periodAllTimePillKey = Key(
    'leaderboard-ai-period-all-time-pill',
  );
  static const periodMonthlyPillKey = Key('leaderboard-ai-period-monthly-pill');
  static const qualificationCardKey = Key('leaderboard-ai-qualification-card');
  static const rankingSectionLabelKey = Key(
    'leaderboard-ai-ranking-section-label',
  );
  static const rankCard1Key = Key('leaderboard-ai-rank-card-1');
  static const rankCard2Key = Key('leaderboard-ai-rank-card-2');
  static const rankCard3Key = Key('leaderboard-ai-rank-card-3');
  static const yourPositionCardKey = Key('leaderboard-ai-your-position-card');
  static const howRankingWorksKey = Key('leaderboard-ai-how-ranking-works');
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                        ...
                        children: [
                          ...
                          Semantics(
                            ...
                            child: GestureDetector(
                              ...
                              onTap: () =>
                                  context.go(AppRoutePaths.leaderboardHuman),
                              child: Container(
                                width: 84,
                                height: 34,
                                alignment: Alignment.center,
                      ...
                      // Qualification Card (y=274, w=350, h=82)
                      SizedBox(
                            ...
                            children: [
                              ...
                              Text(
                                isMonthly
                                    ...
                                    : '3 Approved AI evaluations in this scope.',
                      ...
                      LeaderboardRankCard(
                        ...
                        rank: '1',
                        name: 'Speaker A',
                        alr: isMonthly ? 'ALR 94.0' : 'ALR 92.4',
                      ...
                      LeaderboardRankCard(
                        key: rankCard2Key,
                        rank: '2',
                        name: isMonthly ? 'Speaker C' : 'Speaker B',
                        alr: isMonthly ? 'ALR 91.5' : 'ALR 90.9',
                        participation: isMonthly
                            ? 'Participation 4'
                            : 'Participation 5',
                      ),
                      ...
                      LeaderboardRankCard(
                        key: rankCard3Key,
                        rank: '3',
                        name: isMonthly ? 'Speaker B' : 'Speaker C',
                        alr: isMonthly ? 'ALR 89.0' : 'ALR 89.7',
                        participation: isMonthly
                            ? 'Participation 2'
                            : 'Participation 9',
                      ),
                      ...
                      // Your Position Card (y=632, w=350, h=74)
                      SizedBox(
                        key: yourPositionCardKey,
                        width: double.infinity,
                        height: 74,
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                isMonthly
                                    ? 'ALR 87.5  •  Participation 3'
                                    : 'ALR 86.4  •  Participation 3',
                                style: AuratioTypography.caption.copyWith(
                                  color: AuratioColors.textSecondary,
                                  fontSize: 11,
                                  height: 16 / 11,
