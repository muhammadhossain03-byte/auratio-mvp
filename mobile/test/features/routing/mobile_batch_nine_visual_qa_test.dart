...
void main() {
  group('Batch 9 Visual QA Verification', () {
    testWidgets('visual QA: Pending Moderation (282:568) layout and card states', (
      tester,
    ) async {
    ...
    testWidgets('visual QA: Evaluation Rejected (282:588) layout and card states', (
      tester,
    ) async {
      final router = await pumpAuratioApp(tester);
      await openAuratioRoute(
      ...
      expect(
        find.text('The completed evaluation was not accepted for publication.'),
        findsOneWidget,
      );
