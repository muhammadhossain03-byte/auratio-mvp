  ...
  group('Batch 13 Exact Figma Geometry Verification at 390 × 844', () {
    testWidgets('Profile (295:179) rendered rectangles match Figma metadata', (
      ...
      final accountRect = tester.getRect(
        find.byKey(ProfileScreen.accountCardKey),
      );
      ...
      final pathsRect = tester.getRect(
        find.byKey(ProfileScreen.selectedPathsCardKey),
      );
      ...
      final activityRect = tester.getRect(
        find.byKey(ProfileScreen.activityCardKey),
      );
      ...
      final settingsRect = tester.getRect(
        find.byKey(ProfileScreen.settingsButtonKey),
      );
    ...
    testWidgets('Settings (295:214) rendered rectangles match Figma metadata', (
      ...
      final accountRect = tester.getRect(
        find.byKey(SettingsScreen.accountCardKey),
      );
      expect(accountRect.left, 20.0);
      ...
      final prefRect = tester.getRect(
        find.byKey(SettingsScreen.eventPreferencesCardKey),
      );
      ...
      final privacyRect = tester.getRect(
        find.byKey(SettingsScreen.privacyCardKey),
      );
      ...
      final signOutRect = tester.getRect(
        find.byKey(SettingsScreen.signOutVisualKey),
      );
      ...
      final backRect = tester.getRect(
        find.byKey(SettingsScreen.backToProfileButtonKey),
      );
    ...
    testWidgets(
      ...
      (tester) async {
        ...
        final pubRect = tester.getRect(
          find.byKey(ManagePathsScreen.publicSpeakingCardKey),
        );
        ...
        final presRect = tester.getRect(
          find.byKey(ManagePathsScreen.professionalPresentingCardKey),
        );
        ...
        final infoRect = tester.getRect(
          find.byKey(ManagePathsScreen.infoCardKey),
        );
        ...
        final saveRect = tester.getRect(
          find.byKey(ManagePathsScreen.saveChangesButtonKey),
        );
