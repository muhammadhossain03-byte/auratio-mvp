...
async function inspectBatch4Geometry() {
  ...
  try {
    ...
    const routes = [
      '/admin/dashboard',
      '/admin/requests',
      '/admin/requests/req-1042',
      '/admin/requests/req-1042/assign',
      '/admin/requests/req-1042/reassign',
      '/admin/evaluations',
      '/admin/requests/req-1041',
      '/admin/requests/req-1034',
      '/admin/evaluations/sub-8834',
      '/admin/evaluations/sub-8798',
    ]
    ...
    console.log('\nALL 10 BATCH 4 ROUTES PASSED GEOMETRY VALIDATION!')
...
inspectBatch4Geometry().catch((err) => {
