export const portalRoutePaths = {
  ...
  admin: {
    ...
    cancelRequest: '/admin/requests/req-1042/cancel',
    ...
    evaluationReassignmentPicker: '/admin/evaluations/sub-8834/reassign',
    confirmEvaluationReassignment: '/admin/evaluations/sub-8834/reassign/confirm',
    cancelEvaluationRequest: '/admin/evaluations/sub-8834/cancel',
