...
export function VolunteerCompletedProcessingPage() {
  return (
    <VolunteerLayout
    ...
    >
      <h2 className="auratio-volunteer-page-title" style={{ top: '34px' }}>
        SUB-8741 — Completed Evaluator Work
      </h2>
      <p className="auratio-volunteer-page-subtitle" style={{ top: '78px' }}>
        Evaluator task complete • publication decision processing
      </p>
        ...
        >
          <h4
            style={{
              ...
              fontWeight: 600,
              lineHeight: '26px',
              color: 'var(--auratio-brand-navy-800)',
            }}
          >
