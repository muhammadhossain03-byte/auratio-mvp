...
export function AdminRequestAssignedHumanPage() {
  const navigate = useNavigate()

  return (
    <AdminLayout
      ariaLabel="Request Details Assigned Human"
      ...
      >
        ...
        <div style={{ marginTop: '28px' }}>
          ...
          <div style={{ fontSize: '12px', fontWeight: 400, lineHeight: '18px', color: '#4E5968', marginTop: '6px', width: '488px' }}>
            This request is already routed to Human Evaluation. Assignment state and subsequent moderation are managed under Evaluations and Moderation.
          </div>
