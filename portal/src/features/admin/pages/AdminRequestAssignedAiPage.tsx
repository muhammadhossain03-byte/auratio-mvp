...
export function AdminRequestAssignedAiPage() {
  const navigate = useNavigate()

  return (
    <AdminLayout
      ariaLabel="Request Details Assigned AI"
    ...
    >
      ...
      >
        Eligible recording already routed to AI Evaluation
      </p>
      ...
      >
        ...
        <div style={{ marginTop: '28px' }}>
          ...
          <div style={{ fontSize: '12px', fontWeight: 400, lineHeight: '18px', color: '#4E5968', marginTop: '6px', width: '488px' }}>
            This request is already routed to its requested AI Evaluation path. No Human assignment action is needed from this state.
          </div>
          ...
          <div style={{ fontSize: '11px', fontWeight: 500, lineHeight: '16px', color: '#6B788A', marginTop: '22px', width: '488px' }}>
            Final publication state remains separate from request routing and is tracked in Evaluations.
          </div>
        </div>
      </div>
